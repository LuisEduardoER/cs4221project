...
public class FD implements Comparable
{
    ...
    public BitSet ToBitSet(char a, int size) throws Exception{
        ...
        int id = a - 'A';
        if(id >= size) throw new Exception("Invalid Arribute");
        bits.flip(id);
        return bits;
    }
    ...
    public static void test()throws Exception{                
        ...
        fd5.printFD();
        fd6.printFD();
        if(fd2.Leftequals(fd1)) System.out.println("Left of fd2 equals left of fd1");
        if(fd3.Rightequals(fd1)) System.out.println("Right of fd3 equals Right of fd1");
        if(fd4.equals(fd1)) System.out.println("Fd4 equals fd1");
        if(fd5.compareTo(fd1) > 0) System.out.println("fd3 > fd1");
